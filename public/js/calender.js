...
!(function (e, n) {
    ...
    function k(p, v) {
        ...
        function R(e, n, t, a) {
            ...
            let month = parseInt(n.getMonth().toString());
            month++;

            let sss = w.config.disableCustom
            if(month <= 9) {
                month = month.toString();
                month = "0"+month;
            }
            
            let string = n.getFullYear().toString()+"-"+month.toString()+"-"+n.getDate().toString();
            if(sss.includes(string)) {
        ...
        function De(e, n) {
            if (void 0 !== w.config) {
                ...
                "onChange" === e && (w.input.dispatchEvent(we("change", n)), w.input.dispatchEvent(we("input")));
            }
        }
        function we(e ,d) {
            console.log(d)
                                ...
                                if (
                                    (e.appendChild(
                                        ...
                                        Object.defineProperty(w, "_hidePrevMonthArrow", {
                                            ...
                                            set: function (e) {
                                                w.__hidePrevMonthArrow !== e && (s(w.prevMonthNav, "flatpickr-disablede", e), (w.__hidePrevMonthArrow = e));
                                            },
                                        }),
                                        Object.defineProperty(w, "_hideNextMonthArrow", {
                                            ...
                                            set: function (e) {
                                                w.__hideNextMonthArrow !== e && (s(w.nextMonthNav, "flatpickr-disablede", e), (w.__hideNextMonthArrow = e));
                                            },
                                        }),
