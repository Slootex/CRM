<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				"							<div class=\"btn-group\">\n" . 
				"								<button type=\"submit\" name=\"shopin_relocate\" value=\"rueckgaengig\" class=\"btn btn-danger\" onclick=\"return confirm('Wollen Sie den Eintrag wircklich rückgängig machen?')\">rückgängig <i class=\"fa fa-undo\" aria-hidden=\"true\"></i></button>&nbsp;\n" . 
				...
				"										<button type=\"submit\" name=\"shopin_relocate\" value=\"save\" class=\"btn btn-success btn-lg w-100\"><h1>abschliessen <i class=\"fa fa-check\" aria-hidden=\"true\"></i></h1></button>\n" . 
				"									</div>\n" . 
				"								</div>\n" . 
				"							</div>\n" . 
