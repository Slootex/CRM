<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				"										<input type=\"checkbox\" id=\"radio_technic_1\" name=\"radio_technic_1\" value=\"1\" class=\"custom-control-input bootstrap-switch-access-yes-no\" onchange=\"
				if(document.getElementById('radio_technic_1').checked && document.getElementById('radio_technic_2').checked){
					//$('#store_button').removeClass('d-none');
				}else{
					//$('#store_button').addClass('d-none');
				}\" />\n" . 
				"										<label class=\"custom-control-label\" for=\"radio_technic_1\" onclick=\"
				if(document.getElementById('radio_technic_1').checked && document.getElementById('radio_technic_2').checked){
					//$('#store_button').removeClass('d-none');
				}else{
					//$('#store_button').addClass('d-none');
				...
				"								<div class=\"col-sm-4\">\n" . 
				"									<div class=\"custom-control custom-checkbox mt-2\">\n" . 
				"										<input type=\"checkbox\" id=\"radio_technic_2\" name=\"radio_technic_2\" value=\"1\" class=\"custom-control-input bootstrap-switch-access-yes-no\" onchange=\"
				if(document.getElementById('radio_technic_1').checked && document.getElementById('radio_technic_2').checked){
					//$('#store_button').removeClass('d-none');
				}else{
					//$('#store_button').addClass('d-none');
				}\" />\n" . 
				"										<label class=\"custom-control-label\" for=\"radio_technic_2\" onclick=\"
				if(document.getElementById('radio_technic_1').checked && document.getElementById('radio_technic_2').checked){
					//$('#store_button').removeClass('d-none');
				}else{
					//$('#store_button').addClass('d-none');
				...
				"										<button type=\"submit\" name=\"shopin_next_storage\" value=\"save\" class=\"btn btn-success btn-lg w-100\"><h1>abschliessen <i class=\"fa fa-check\" aria-hidden=\"true\"></i></h1></button>\n" . 
				"									</div>\n" . 
				"								</div>\n" . 
				"							</div>\n" . 
