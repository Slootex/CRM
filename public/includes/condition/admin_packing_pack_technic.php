<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				"				<div class=\"row\">\n" . 
				"					<div class=\"col-sm-6\">\n" . 
				"						<h3 class=\"mt-1 mb-0\">Bearbeiten - Techniker</h3>\n" . 
				"					</div>\n" . 
				...
				"							<input type=\"hidden\" name=\"id\" value=\"" . intval($_POST['id']) . "\" />\n" . 
				"							<input type=\"hidden\" name=\"order_id\" value=\"" . intval($row_packing['order_id']) . "\" />\n" . 
				"							<button type=\"submit\" name=\"packing_technic\" value=\"speichern\" class=\"btn btn-success\">speichern <i class=\"fa fa-floppy-o\" aria-hidden=\"true\"></i></button>\n" . 
