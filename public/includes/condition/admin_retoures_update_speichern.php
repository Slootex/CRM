	...
	if($emsg == ""){
		...
		mysqli_query($conn, "	INSERT 	`" . $shopping_table . "_events` 
								SET 	`" . $shopping_table . "_events`.`company_id`='" . mysqli_real_escape_string($conn, intval($_SESSION["admin"]["company_id"])) . "', 
										...
										`" . $shopping_table . "_events`.`message`='" . mysqli_real_escape_string($conn, $shopping_name . ", Retourendaten geändert, ID [#" . intval($_POST["id"]) . "]") . "', 
										`" . $shopping_table . "_events`.`subject`='" . mysqli_real_escape_string($conn, $shopping_name . ", Retourendaten geändert, ID [#" . intval($_POST["id"]) . "]") . "', 
		...
		$emsg = "<p>Die Retoure wurde erfolgreich geändert!</p>\n";
