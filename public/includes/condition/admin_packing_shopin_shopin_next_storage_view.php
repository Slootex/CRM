<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				"				<div class=\"row\">\n" . 
				"					<div class=\"col-sm-6\">\n" . 
				"						<h3 class=\"mt-1 mb-0\">Wareneingang ansehen - Auftragsgerät wurde erneut eingelagert</h3>\n" . 
				"					</div>\n" . 
				...
				"								<label class=\"col-sm-4 text-success\"><h3 class=\"mt-2\">Auftragsgerät erneut eingelagert</h3></label>\n" . 
				"								<div class=\"col-sm-4\">\n" . 
