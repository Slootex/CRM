<?php 
	...
	$result = mysqli_query($conn, "	SELECT 		`user_users_events`.`id` AS id, 
												(
													SELECT 	name 
													FROM 	`admin` `admin` 
													WHERE 	`admin`.`id`=`user_users_events`.`admin_id` 
	...
	$tabs_contents .= 	"				<div class=\"row\">\n" . 
						...
						"										<form action=\"" . $order_action . "\" method=\"post\" enctype=\"multipart/form-data\" style=\"float: right\" class=\"\">\n" . 
						"											<input type=\"hidden\" name=\"id\" value=\"" . intval($_POST['id']) . "\" />\n" . 
						"											<button type=\"submit\" name=\"delete\" value=\"Kunde unwiederuflich löschen\" onclick=\"return confirm('Wollen Sie den Eintrag wircklich entfernen?')\" class=\"btn btn-danger\">Kunde unwiederuflich löschen <i class=\"fa fa-ban\" aria-hidden=\"true\"></i></button>\n" . 
						"										</form>\n" . 
						"									</div>\n" . 
						"								</div>\n" . 
						"							</div>\n" . 
