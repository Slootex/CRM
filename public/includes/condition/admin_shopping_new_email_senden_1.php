	...
	if($emsg == ""){
		...
		mysqli_query($conn, "	INSERT 	`" . $shopping_table . "_statuses` 
								SET 	`" . $shopping_table . "_statuses`.`company_id`='" . mysqli_real_escape_string($conn, intval($_SESSION["admin"]["company_id"])) . "', 
										...
										`" . $shopping_table . "_statuses`.`status_id`='" . mysqli_real_escape_string($conn, intval($maindata['email_status'])) . "', 
										...
										`" . $shopping_table . "_statuses`.`body`='" . mysqli_real_escape_string($conn, str_replace("[track]", "", $row_template['body'])) . "', 
										`" . $shopping_table . "_statuses`.`public`='1', 
										`" . $shopping_table . "_statuses`.`time`='" . $time . "'");

		$_SESSION["status"]["id"] = $conn->insert_id;

		mysqli_query($conn, "	INSERT 	`" . $shopping_table . "_emails` 
								SET 	`" . $shopping_table . "_emails`.`company_id`='" . mysqli_real_escape_string($conn, intval($_SESSION["admin"]["company_id"])) . "', 
										`" . $shopping_table . "_emails`.`admin_id`='" . mysqli_real_escape_string($conn, intval($_SESSION["admin"]["id"])) . "', 
										`" . $shopping_table . "_emails`.`shopping_id`='" . mysqli_real_escape_string($conn, intval($_POST['id'])) . "', 
										`" . $shopping_table . "_emails`.`subject`='" . mysqli_real_escape_string($conn, $row_template['subject']) . "', 
										`" . $shopping_table . "_emails`.`body`='" . mysqli_real_escape_string($conn, str_replace("[track]", "", $row_template['body'])) . "', 
										`" . $shopping_table . "_emails`.`time`='" . mysqli_real_escape_string($conn, intval($time)) . "'");
		...
		mysqli_query($conn, "	INSERT 	`" . $shopping_table . "_events` 
								SET 	`" . $shopping_table . "_events`.`company_id`='" . mysqli_real_escape_string($conn, intval($_SESSION["admin"]["company_id"])) . "', 
										...
										`" . $shopping_table . "_events`.`message`='" . mysqli_real_escape_string($conn, "E-Mail - " . $row_template['name'] . ", gesendet, ID [#" . $_SESSION["emails"]["id"] . "]") . "', 
										`" . $shopping_table . "_events`.`subject`='" . mysqli_real_escape_string($conn, $row_template['subject']) . "', 
										`" . $shopping_table . "_events`.`body`='" . mysqli_real_escape_string($conn, str_replace("[track]", "", $row_template['body'])) . "', 
		...
		if(($_POST['new_email'] == "senden" && $row_template['mail_with_pdf'] == 1) || ($_POST['new_email'] == "sofort senden" && $row_template['mail_with_pdf'] == 1)){
			...
			if(($_POST['new_email'] == "senden" && $row_status['usermail'] == 1 && $new_email_email != "") || ($_POST['new_email'] == "sofort senden" && $row_status['usermail'] == 1 && $_POST['new_email_email'] != "")){
			...
			if(($_POST['new_email'] == "senden" && $row_status['adminmail'] == 1) || ($_POST['new_email'] == "sofort senden" && $row_status['adminmail'] == 1)){
