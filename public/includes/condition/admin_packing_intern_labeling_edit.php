<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				"				<div class=\"row\">\n" . 
				"					<div class=\"col-sm-6\">\n" . 
				"						<h4 class=\"mt-1 mb-0\">Intern Beschriften bearbeiten " . $row_intern['intern_number'] . "</h4>\n" . 
				"					</div>\n" . 
				...
				"									<input type=\"hidden\" name=\"id\" value=\"" . intval($_POST['id']) . "\" />\n" . 
				"									<button type=\"submit\" name=\"intern_labeling_update\" value=\"speichern\" class=\"btn btn-success\">speichern <i class=\"fa fa-save\" aria-hidden=\"true\"></i></button>\n" . 
				"								</div>\n" . 
				"							</div>\n" . 
