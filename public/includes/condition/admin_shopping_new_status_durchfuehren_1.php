	...
	if($emsg == ""){
		...
		mysqli_query($conn, "	INSERT 	`" . $shopping_table . "_statuses` 
								SET 	`" . $shopping_table . "_statuses`.`company_id`='" . mysqli_real_escape_string($conn, intval($_SESSION["admin"]["company_id"])) . "', 
										...
										`" . $shopping_table . "_statuses`.`public`='" . mysqli_real_escape_string($conn, intval(isset($_POST['public']) ? $_POST['public'] : 0)) . "', 
...
/*		if($row_status['id'] == $maindata['shopping_ending_status']){
