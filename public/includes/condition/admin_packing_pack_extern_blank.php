<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				"				<div class=\"row\">\n" . 
				"					<div class=\"col-sm-6\">\n" . 
				"						<h3 class=\"mt-1 mb-0\">Bearbeiten - Extern ohne Geräte</h3>\n" . 
				"					</div>\n" . 
				...
				"				<h5>Bearbeiten Versandauftrag - Extern ohne Geräte</h5>\n" . 
				...
				"							<input type=\"hidden\" name=\"id\" value=\"" . intval($_POST['id']) . "\" />\n" . 
				"							<input type=\"hidden\" name=\"order_id\" value=\"" . intval($row_packing['order_id']) . "\" />\n" . 
				"							<button type=\"submit\" name=\"packing_extern_blank\" value=\"speichern\" class=\"btn btn-success\">speichern <i class=\"fa fa-floppy-o\" aria-hidden=\"true\"></i></button>\n" . 
