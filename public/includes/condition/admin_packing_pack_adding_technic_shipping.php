...
/*	$arr_order_extended_items = explode("\r\n", $maindata['order_extended_items']);
	...
	$html .= 	$js_devices . 
				...
				"										<input type=\"hidden\" name=\"id\" value=\"" . intval($_POST['id']) . "\" />\n" . 
				"										<button type=\"submit\" name=\"packing_adding_technic_shipping\" value=\"durchfuehren\" class=\"btn btn-success btn-lg\" style=\"width: 330px\"><h1>versenden <i class=\"fa fa-truck\" aria-hidden=\"true\"></i></h1></button>&nbsp;&nbsp;&nbsp;\n" . 
				"										<button type=\"submit\" name=\"packing_adding_technic_shipping\" value=\"durchfuehren ohne Sendung\" class=\"btn btn-success btn-lg\" style=\"width: 330px\"><h1>verpacken <i class=\"fa fa-gift\" aria-hidden=\"true\"></i></h1></button>\n" . 
				"										<br />\n" . 
