<?php 
	...
	if($emsg == ""){
		...
		for($item = 0;$item < count($arr_order_extended_items);$item++){
			...
			$script_paste .= "if(document.getElementById('" . $arr_item[0] . "')){document.getElementById('" . $arr_item[0] . "').checked=" . (isset($_POST[$arr_item[0]]) && intval($_POST[$arr_item[0]]) == 1 ? "true" : "false") . ";}\n";

		}

		$script_paste .= "document.getElementById('file1').value=" . intval(isset($_POST['file1']) && intval($_POST['file1']) > 0 ? $_POST['file1'] : 0) . ";\n";
		$script_paste .= "document.getElementById('file2').value=" . intval(isset($_POST['file2']) && intval($_POST['file2']) > 0 ? $_POST['file2'] : 0) . ";\n";
