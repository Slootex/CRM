<?php 
	...
	$html .= 	"<hr />\n" . 
				...
				if(document.getElementById('device_barcode').value=='" . $row_shopin['help_device_number'] . "'){
				...
				"										<div class=\"input-group-append w-25\" ondblclick=\"
				document.getElementById('storage_space_barcode').value=document.getElementById('storage_space').value;
				if(document.getElementById('storage_space_barcode').value=='" . $row_shopin['storage_space'] . "'){
				...
				($docs_count > 0 || file_exists("uploads/company/" . intval($_SESSION["admin"]["company_id"]) . "/scan/" . $row_shopin['help_device_number'] . ".pdf") ? 
				...
				"							<div class=\"row my-3" . ($docs_count == 0 && !file_exists("uploads/company/" . intval($_SESSION["admin"]["company_id"]) . "/scan/" . $row_shopin['help_device_number'] . ".pdf") ? "" : " d-none") . "\">\n" . 
				"								<div class=\"col-sm-8\">\n" . 
				...
				"										<button type=\"submit\" name=\"shopin_none\" value=\"store\" class=\"btn btn-success btn-lg w-100\"><h1>einlagern <i class=\"fa fa-tasks\" aria-hidden=\"true\"></i></h1></button>\n" . 
				"									</div>\n" . 
				"								</div>\n" . 
				"							</div>\n" . 
				...
				"									<button type=\"submit\" name=\"shopin_order\" value=\"none\" class=\"btn btn-secondary btn-lg\"><i class=\"fa fa-refresh\"></i></button>\n" . 
				"								</form>\n" . 
				"							</div>\n" . 
				"						</div>\n" . 
