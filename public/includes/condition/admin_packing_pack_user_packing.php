...
*/
	$html .= 	$js_devices . 
				...
				: 
					...
					"										<input type=\"hidden\" name=\"id\" value=\"" . intval($_POST['id']) . "\" />\n" . 
					"										<input type=\"hidden\" name=\"order_id\" value=\"" . intval($row_packing['order_id']) . "\" />\n" . 
					"										<button type=\"submit\" name=\"packing_user\" value=\"verpacken\" class=\"btn btn-success btn-lg w-100\"><h1>versenden <i class=\"fa fa-truck\" aria-hidden=\"true\"></i></h1></button><br />\n" . 
