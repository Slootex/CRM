...
$parameter['tab'] = "edit";
$parameter['link'] = "neue-auftraege";

$order_session = "orders";
$order_action = "/crm/neue-auftraege";
...
if(isset($_POST['multi_status']) && $_POST['multi_status'] == "durchführen" && isset($_POST['status']) && intval($_POST['status']) > 0 && isset($_POST['to_archiv'])){
	...
	$parameter['order_to_archive_status'] = "order_to_archive_status";

	include("includes/condition/admin_order_multi_status_to_archiv.php");
...
if(isset($_POST['multi_to_archiv']) && $_POST['multi_to_archiv'] == "durchführen"){
	...
	include("includes/condition/admin_order_multi_to_archiv.php");
...
if(isset($_POST['save']) && $_POST['save'] == "speichern"){
	...
	$parameter['link_edit'] = "neue-auftraege";

	$parameter['order_status_intern'] = "order_status_intern";

	include("includes/condition/admin_order_save_speichern_" . intval($_SESSION["admin"]["theme_id"]) . ".php");
...
if(isset($_POST['move']) && $_POST['move'] == "Archiv"){
	...
	include("includes/condition/admin_order_move_archiv.php");
...
if(isset($_POST['move_interested']) && $_POST['move_interested'] == "Zu Interessenten"){
	...
	$parameter['archive_to_interested_status'] = "order_to_interested_status";
...
$html = "<div class=\"row\">\n" . 
		...
		"<div class=\"row\">\n" . 
		"	<div class=\"col-7\">\n" . 
		"		" . (!isset($_POST['delete']) && isset($_POST['id']) && intval($_POST['id']) > 0 ? "<h3>Auftragsübersicht-Auftragsnummer: " . $row_order['order_number'] . " <i class=\"" . $payings->getPoint() . "\"></i></h3><p id=\"user_info\" class=\"mb-0\">" . ($row_order['companyname'] != "" ? "Firma: " . $row_order['companyname'] . ", " : "") . "Name: " . ($row_order['gender'] == 1 ? "Frau" : "Herr") . " " . $row_order['firstname'] . " " . $row_order['lastname'] . "</p>" : (isset($_POST['add']) && $_POST['add'] == "hinzufügen" ? "<h3>Neuer Auftrag</h3>" : "<h3>Auftragsübersicht</h3>")) . "\n" . 
		"	</div>\n" . 
...
if(isset($_POST['add']) && $_POST['add'] == "hinzufügen"){
	...
	include("includes/condition/admin_order_add_hinzufuegen_" . intval($_SESSION["admin"]["theme_id"]) . ".php");
