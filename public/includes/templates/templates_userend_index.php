...
<body>
<?php 
	echo ($emsg != "" ? "<div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\">\n" . $emsg . "<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button></div>\n" : "");
?>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				<nav class="navbar navbar-expand-lg navbar-dark p-0">
					<?php if($maindata['logo_url'] != ""){ ?><a href="<?php echo $maindata['logo_url']; ?>"<?php echo $maindata['logo_url'] == "#" ? " onclick=\"toggleFullscreen()\"" : ""; ?>><img src="/img/admin_gzamotors_logo.png" alt="Logo" style="width: 32px;margin: 2px" /></a><?php } ?>
						...
						<ul id="menu-1" class="navbar-nav mr-0">
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu" role="menu">
									<li class="nav-item"><a href="/kunden/dashboard" title="Startseite" class="dropdown-item bg-<?php echo $row_admin["color_link"]; ?> active">Dashboard</a></li>
									<li class="nav-item"><a href="/kunden/daten" title="Eigene Daten" class="dropdown-item">Eigene Daten</a></li>
									<li class="nav-item"><a href="/kunden/kennwort" title="Kennwort ändern" class="dropdown-item">Kennwort ändern</a></li>
