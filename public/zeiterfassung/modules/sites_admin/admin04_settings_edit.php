...
<div id="kn">
	...
	<div id="myTabContent" class="tab-content">
		<div id="s1" class="tab-pane fade<?php echo $s011; ?>">
			<p id="content">
				<?php
				include('modules/sites_crm/settings/001.php');
				?>
			</p>
		</div>
		<div id="s2" class="tab-pane fade<?php echo $s021; ?>">
			<p id="content">
				<?php
				include('modules/sites_crm/settings/002.php');
				?>
			</p>
		</div>
		<div id="s3" class="tab-pane fade<?php echo $s031; ?>">
			<p id="content">
				<?php
				include('modules/sites_crm/settings/003.php');
				?>
			</p>
		</div>
		<div id="s4" class="tab-pane fade<?php echo $s041; ?>">
			<p id="content">
				<?php
				include('modules/sites_crm/settings/pausen.php');
				?>
			</p>
		</div>
	</div>
