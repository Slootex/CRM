...
if(@$_SESSION['admin_x'] and !@$_GET['action']){
	$_logcheck->rapport(@$_SESSION['admin_x'],"korrekt", "Session");
}
// keine Session vorhanden
if(@$_SESSION['admin_x'] == NULL OR @$_SESSION['admin_x'] == ""){
	$_Userpfad = @$_SESSION['admin_x']."/";
}
// Login über Cookie mit Datenüberprüfung
if(@$_COOKIE["lname"] and @$_COOKIE["lpass"] and (@$_SESSION['admin_x'] == NULL OR @$_SESSION['admin_x'] == "")){
...
if(@$_SESSION['admin_x'] and !@$_GET['action']){
	$_action = "show_admin";
}elseif(@$_GET['action'] && @$_SESSION['admin_x']){
	$_action = @$_GET['action'];
...
switch(@$_action){
	...
	if(isset($_GET['function'])){
		...
		$_template->_user01 = "sites_crm/admin01.php";
		$_template->_user02 = "sites_crm/admin02.php";
		$_template->_user04 = "sites_crm/admin04_pdfgenerate.php";
		$_template->_user03 = "sites_crm/admin03.php";
	}
	break;
	case "edit_ausz":
	$auszahlung = new auszahlung($_GET['monat'],$_GET['jahr']);
	$_template->_user04 = "sites_crm/admin04_auszahlung.php";
	break;
	case "update_ausz":
	$auszahlung = new auszahlung($_GET['monat'],$_GET['jahr']);
	...
	if(isset($_GET['excel'])){
		...
		$_datei = $_datei . ".xls";
		$_call  = $_GET['excel'];
		$_template->_user04 = "sites_crm/export_xls_".$_call.".php";
	}else{
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_idtime_generate.php";
	break;
	case "zip_user":
	...
	if(@$_POST['absenden'] == "OK"){
		...
		$_template->_user02 = "sites_crm/admin02.php";
		$_template->_user04 = "sites_crm/admin04.php";
		...
		$_template->_user02 = "sites_crm/admin02.php";
		$_template->_user04 = "sites_crm/admin04_user_del.php";
	}
	break;
	case "import":
	$_infotext = getinfotext("CSV - Import (z.B.IPhone APP TimeOrg - timeorg.zimco.com)","td_background_top");
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_csv_import.php";
	break;
	case "anwesend":
	...
	$_template->_user02 = "sites_crm/admin02_user_cal.php";
	...
	if(isset($_GET['excel'])){
		...
		$_datei = $_datei . "-" . $_time->_monat;
		$_datei = $_datei . ".xls";
		$_template->_user04 = "sites_crm/export_xls_monat.php";
	}
	break;
	case "show_pdf":
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_user_einstellungen.php";
	break;
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_user_edit.php";
	break;
	case "user_update":
	if(@$_POST['absenden'] == "OK"){
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_user_editabsenzen.php";
	break;
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_personalkarte.php";
	break;
	case "group";
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_group_edit.php";
	break;
	case "settings";
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_settings_edit.php";
	break;
	case "feiertage";
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_feiertage_edit.php";
	break;
	case "user_add":
	if(@$_POST['absenden'] == "OK"){
		$_a = $_POST['_a'];
	...
	$_template->_user02 = "sites_crm/admin02.php";
	$_template->_user04 = "sites_crm/admin04_user_add.php";
	break;
	default:
	setLoginForm();
	break;
