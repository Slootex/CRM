...
* Version 0.9.021
* Author:  ORDERGO
* www.ordergo.de / info@ordergo.de
* Copyright (c), ORDERGO, All rights reserved
*******************************************************************************/
?>
<!DOCTYPE html>
<html lang="de">
	<head><title>CRM P+</title>
		...
		echo "\n";
		?>
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $_template->get_templatepfad() ?>css/ordergo.css">
	</head>
	<?php //if($_modal == false)
	if($_modal == false){
		?>
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="span12">
						<img style="width:100%" src="<?php echo $_template->get_templatepfad() ?>images/ordergo.jpg">
					</div>
				</div>
				<div class="row">
					<div class="span3">
