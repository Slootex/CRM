...
* Version 0.9.021
* Author:  GZAMOTORS
* www.gzamotors.de / info@gzamotors.de
* Copyright (c), GZAMOTORS, All rights reserved
*******************************************************************************/
?>
<!DOCTYPE html>
<html lang="de">
	<head><title>CRM P+</title>
		...
		echo "\n";
		?>
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $_template->get_templatepfad() ?>css/gzamotors.css">
	</head>
	<?php //if($_modal == false)
	if($_modal == false){
		?>
		<body>
			...
			<div class="container">
				<div class="row">
					<div class="span12">
						<img style="width:100%" src="<?php echo $_template->get_templatepfad() ?>images/gzamotors.jpg">
					</div>
				</div>
				<div class="row">
					<div class="span3">
