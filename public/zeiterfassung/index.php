...
$_now        = isset($_GET['token']) ? $_GET['token'] : "";
$token       = md5(uniqid('SmallTime'));
//echo  $_SESSION['last'] . " - " . $_now ;
//echo " < br > ";
$_SESSION['last'] = isset($_SESSION['last']) ? $_SESSION['last'] : "";
...
if(isset($_SESSION['admin_x']) && !isset($_GET['action'])){
	$_logcheck->rapport($_SESSION['admin_x'],"korrekt", "Session");
}
// keine Session vorhanden
if(!$_POST AND ($_SESSION['admin_x'] == NULL OR $_SESSION['admin_x'] == "")){
...
if(isset($_COOKIE["lname"]) and isset($_COOKIE["lpass"]) and $_settings->_array[19][1] == "0" and (!isset($_SESSION['admin_x']) OR (isset($_SESSION['admin_x']) && $_SESSION['admin_x'] == ""))){
...
// ----------------------------------------------------------------------------
$_grpwahl = isset($_GET['group']) ? $_GET['group'] - 1 : 0;
// Session  vorhanden - Daten anzeigen
if($_SESSION['admin_x'] and !isset($_GET['action'])){
	$_action = "show_time";
