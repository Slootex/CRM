...
--
-- Table structure for table `intern_archives`
--

DROP TABLE IF EXISTS `intern_archives`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `intern_archives` (
...
--
-- Dumping data for table `intern_archives`
--

LOCK TABLES `intern_archives` WRITE;
/*!40000 ALTER TABLE `intern_archives` DISABLE KEYS */;
/*!40000 ALTER TABLE `intern_archives` ENABLE KEYS */;
UNLOCK TABLES;
