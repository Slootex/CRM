...
--
-- Table structure for table `archive_lead_car_datas`
--

DROP TABLE IF EXISTS `archive_lead_car_datas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `archive_lead_car_datas` (
...
--
-- Dumping data for table `archive_lead_car_datas`
--

LOCK TABLES `archive_lead_car_datas` WRITE;
/*!40000 ALTER TABLE `archive_lead_car_datas` DISABLE KEYS */;
/*!40000 ALTER TABLE `archive_lead_car_datas` ENABLE KEYS */;
UNLOCK TABLES;
