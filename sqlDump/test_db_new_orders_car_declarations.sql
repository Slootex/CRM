...
--
-- Table structure for table `new_orders_car_declarations`
--

DROP TABLE IF EXISTS `new_orders_car_declarations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `new_orders_car_declarations` (
  `process_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `car_company` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `car_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `production_year` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `broken_component` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `from_car` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `past_car_modifications` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `new_orders_car_declarations`
--

LOCK TABLES `new_orders_car_declarations` WRITE;
/*!40000 ALTER TABLE `new_orders_car_declarations` DISABLE KEYS */;
/*!40000 ALTER TABLE `new_orders_car_declarations` ENABLE KEYS */;
UNLOCK TABLES;
