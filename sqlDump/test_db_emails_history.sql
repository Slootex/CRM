...
DROP TABLE IF EXISTS `emails_history`;
...
--
-- Dumping data for table `emails_history`
--

LOCK TABLES `emails_history` WRITE;
/*!40000 ALTER TABLE `emails_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `emails_history` ENABLE KEYS */;
UNLOCK TABLES;
