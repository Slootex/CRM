...
--
-- Table structure for table `oder_process_data`
--

DROP TABLE IF EXISTS `oder_process_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oder_process_data` (
  ...
  `open_by_user` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_components` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `oder_process_data`
--

LOCK TABLES `oder_process_data` WRITE;
/*!40000 ALTER TABLE `oder_process_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `oder_process_data` ENABLE KEYS */;
UNLOCK TABLES;
