...
CREATE TABLE `audiofiles` (
  ...
  `tophone` varchar(255) DEFAULT NULL,
  `acceptone` varchar(255) DEFAULT NULL,
  `speakaccept` varchar(255) DEFAULT NULL,
  `talkname` varchar(255) DEFAULT NULL,
  `shipafterpay` varchar(255) DEFAULT NULL,
  `priceok` varchar(255) DEFAULT NULL,
  `takebacktalk` varchar(255) DEFAULT NULL,
