...
<title>ORDERGO-CRM - Versenden</title>
...
</script --><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/50/11/intl/de_ALL/common.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/50/11/intl/de_ALL/util.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/50/11/intl/de_ALL/controls.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/50/11/intl/de_ALL/places_impl.js"></script></head>
<body><div data-lastpass-root="" style="position: absolute !important; top: 0px !important; left: 0px !important; height: 0px !important; width: 0px !important;"><div data-lastpass-infield="true" style="position: absolute !important; top: 0px !important; left: 0px !important;"></div></div>
...
<a href="/crm/neue-packtische" title="Packtischübersicht" style="font-size: 1rem" class="navbar-brand extra-hover text-primary p-0">Packtisch</a>
	...
	<li class="nav-item dropdown">
		<a href="#" title="Versand" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link text-primary py-1"><u>Versand</u></a>
		<ul class="dropdown-menu" role="menu">
			<li class="nav-item"><a href="/crm/versenden" title="Versenden" class="dropdown-item bg-primary active">Versenden</a></li>
...
<div class="row">
	<div class="col">
		<div class="card card-maximize bg-white text-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<form action="" method="post">
									<div class="btn-group">
										<input type="text" name="search_order" value="" placeholder="|||||| Suchbegriff" aria-label="Suchbegriff / Barcode" class="form-control form-control-lg bg-white text-primary border border-primary" style="border-radius: .25rem 0 0 .25rem">
	...
	<tbody>
        ...
        <form action="{{url("/")}}/crm/shipping/device" method="post">
            @CSRF
            <tr class="">
                ...
                <td scope="row" align="center">
                    <small>{{$order->process_id}}</small>
                </td>
                <td>
                    <div style="width: 160px;white-space: nowrap;overflow-x: hidden"><small>{{$order->companyname}} @isset($order->companyname) , @endisset {{$order->firstname}} {{$order->lastname}}</small></div>
                </td>
                <td class="text-nowrap">
                ...
                <td align="center">
                    <div style="white-space: nowrap">
                        <input type="hidden" name="order_id" value="{{$order->process_id}}">
        ...
        @endforeach
								...
								<div class="col-sm-3 border-right">
									<form action="{{url("/")}}/crm/shipping/device_cart" method="post">
                                        @CSRF
									...
									<div class="row mb-4">
										<label class="col-sm-5 col-form-label">
											{{$device->component_number}}
										</label>
										<div class="col-sm-2 text-right">
											<label>
												<input type="checkbox" name="comp-{{$counter}}" value="{{$device->component_number}}">
												Ja
											  </label>
										</div>
										<div class="col-sm-5">
				...
				<br>
				<form action="{{url("/")}}/crm/shipping/new" method="post">
                    @CSRF
					<div class="form-group row">
                        @isset($fin_devi)
                        @foreach ($fin_devi as $dev)
                    ...
                    @endforeach
						...
						<div class="col-sm-6 border-right">
							...
							<div class="form-group row">
								<div class="col-sm-6">
									<select id="from_address" name="from_address" class="custom-select" onchange="document.getElementById('from_shortcut').value = document.getElementById('from_address').value">
...
<option value="eLeven">eLeven</option>
								...
								<div class="col-sm-6">
									<input type="text" id="from_shortcut" name="from_shortcut" value="gza" class="form-control" placeholder="Kürzel">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-12">
									<input type="text" id="from_companyname" name="from_companyname" value="GZA MOTORS" class="form-control" placeholder="Firma">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="from_gender_0" name="from_gender" value="0" checked="checked" class="custom-control-input">
										<label class="custom-control-label" for="from_gender_0">
											Herr
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="from_gender_1" name="from_gender" value="1" class="custom-control-input">
								...
								<div class="col-sm-4">
									<input type="text" id="from_firstname" name="from_firstname" value="Gazi" class="form-control" placeholder="Vorname">
								</div>
								<div class="col-sm-4">
									<input type="text" id="from_lastname" name="from_lastname" value="Ahmad" class="form-control" placeholder="Nachname">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-9">
									<input type="text" id="from_street" name="from_street" value="Strausberger Platz" class="form-control pac-target-input" placeholder="Straße" autocomplete="off">
								</div>
								<div class="col-sm-3">
									<input type="text" id="from_streetno" name="from_streetno" value="13" class="form-control" placeholder="Nr">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4">
									<input type="text" id="from_zipcode" name="from_zipcode" value="10243" class="form-control pac-target-input" placeholder="Postleitzahl" autocomplete="off">
								</div>
								<div class="col-sm-4">
									<input type="text" id="from_city" name="from_city" value="Berlin" class="form-control pac-target-input" placeholder="Ort" autocomplete="off">
								</div>
								<div class="col-sm-4">
									<select id="from_country" name="from_country" class="custom-select d-none">
...
<option value="12" data-code="HU">Ungarn</option>
									</select><div class="from_country-lang-select" style=""><button type="button" value="1" class="from_country-btn-select px-0" style="width: 100%;padding: 0;border-radius: 5px;background-color: #fff;border: 1px solid #ccc;" onfocus="this.blur()"><li style="float: left; list-style: none; width: 100%; border-radius: 5px; text-align: left; background-color: rgb(255, 255, 255); padding-top: 0.3rem; padding-bottom: 0.3rem; cursor: pointer; color: rgb(0, 0, 0);" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/DE.png" alt="" data-code="DE" data-value="1" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Deutschland</span></li></button><div class="from_country-b" style="display: none;position: absolute;width: 100%;max-width: 350px;box-shadow: 0 6px 12px rgba(0,0,0,.175);border: 1px solid rgba(0,0,0,.15);border-radius: 5px;z-index: 1000"><ul id="from_country-a" style="margin-bottom: 0;padding-left: 0px;"><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/DE.png" alt="" data-code="DE" data-value="1" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Deutschland</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/GB.png" alt="" data-code="GB" data-value="5" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Großbritannien</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/IT.png" alt="" data-code="IT" data-value="8" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Italien</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/LT.png" alt="" data-code="LT" data-value="9" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Litauen</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/LU.png" alt="" data-code="LU" data-value="11" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Luxemburg</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/NL.png" alt="" data-code="NL" data-value="4" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Niederlande</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/AT.png" alt="" data-code="AT" data-value="2" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Österreich</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/PL.png" alt="" data-code="PL" data-value="7" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Polen</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/SE.png" alt="" data-code="SE" data-value="13" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Schweden</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/CH.png" alt="" data-code="CH" data-value="10" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Schweiz</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/ES.png" alt="" data-code="ES" data-value="6" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Spanien</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/HU.png" alt="" data-code="HU" data-value="12" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Ungarn</span></li></ul></div></div>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4">
									<input type="text" id="from_email" name="from_email" value="info@gzamotors.de" class="form-control" placeholder="Email">
								</div>
								<div class="col-sm-4">
									<input type="text" id="from_mobilnumber" name="from_mobilnumber" value="" class="form-control" placeholder="Mobil">
								</div>
								<div class="col-sm-4">
									<input type="text" id="from_phonenumber" name="from_phonenumber" value="042159564922" class="form-control" placeholder="Festnetz">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<div class="custom-control custom-checkbox mt-2 pl-0">
										<input type="checkbox" id="from_mail" name="from_mail" value="1" class="custom-control-input bootstrap-switch" style="display: none;"><div class="btn-group btn-toggle" style="white-space: nowrap;"><button class="btn btn-default  btn-sm" style="float: none; display: inline-block; margin-right: 0px;">Ja</button><button class="btn active btn-danger btn-sm" style="float: none; display: inline-block; margin-left: 0px; transform: scale(1);">Nein </button></div>
										<label class="custom-control-label d-none" for="from_mail">
											Ja
										</label>
									</div>
								</div>
						...
						<div class="col-sm-6">
							...
							<div class="form-group row">
								<div class="col-sm-6">
									<select id="to_address" name="to_address" class="custom-select" onchange="document.getElementById('to_shortcut').value = document.getElementById('to_address').value">
                                        <option value="dirk">dirk</option>
                                        <option value="gza" selected="selected">gza</option>
                                        <option value="stelzhamer">stelzhamer</option>
                                        <option value="konstantinow">konstantinow</option>
								...
								<div class="col-sm-6">
									<input type="text" id="to_shortcut" name="to_shortcut" value="gza" class="form-control" placeholder="Kürzel">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-12">
									<input type="text" id="to_companyname" name="to_companyname" value="GZA MOTORS" class="form-control" placeholder="Firma">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="to_gender_0" name="to_gender" value="0" checked="checked" class="custom-control-input">
										<label class="custom-control-label" for="to_gender_0">
											Herr
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="to_gender_1" name="to_gender" value="1" class="custom-control-input">
								...
								<div class="col-sm-4">
									<input type="text" id="to_firstname" name="to_firstname" value="Gazi" class="form-control" placeholder="Vorname">
								</div>
								<div class="col-sm-4">
									<input type="text" id="to_lastname" name="to_lastname" value="Ahmad" class="form-control" placeholder="Nachname">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-9">
									<input type="text" id="to_street" name="to_street" value="Strausberger Platz" class="form-control pac-target-input" placeholder="Straße" autocomplete="off">
								</div>
								<div class="col-sm-3">
									<input type="text" id="to_streetno" name="to_streetno" value="13" class="form-control" placeholder="Nr">
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4">
									<input type="text" id="to_zipcode" name="to_zipcode" value="10243" class="form-control pac-target-input" placeholder="Postleitzahl" autocomplete="off">
								</div>
								<div class="col-sm-4">
									<input type="text" id="to_city" name="to_city" value="Berlin" class="form-control pac-target-input" placeholder="Ort" autocomplete="off">
								</div>
								<div class="col-sm-4">
									<select id="to_country" name="to_country" class="custom-select d-none" onchange="$('#update_country').click()">
<option value="1" data-code="DE" selected="selected">Deutschland</option>
<option value="5" data-code="GB">Großbritannien</option>
<option value="8" data-code="IT">Italien</option>
<option value="9" data-code="LT">Litauen</option>
...
<option value="6" data-code="ES">Spanien</option>
<option value="12" data-code="HU">Ungarn</option>
									</select><div class="to_country-lang-select" style=""><button type="button" value="1" class="to_country-btn-select px-0" style="width: 100%;padding: 0;border-radius: 5px;background-color: #fff;border: 1px solid #ccc;" onfocus="this.blur()"><li style="float: left;list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/DE.png" alt="" data-code="DE" data-value="1" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Deutschland</span></li></button><div class="to_country-b" style="display: none;position: absolute;width: 100%;max-width: 350px;box-shadow: 0 6px 12px rgba(0,0,0,.175);border: 1px solid rgba(0,0,0,.15);border-radius: 5px;z-index: 1000"><ul id="to_country-a" style="margin-bottom: 0;padding-left: 0px;"><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/DE.png" alt="" data-code="DE" data-value="1" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Deutschland</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/GB.png" alt="" data-code="GB" data-value="5" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Großbritannien</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/IT.png" alt="" data-code="IT" data-value="8" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Italien</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/LT.png" alt="" data-code="LT" data-value="9" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Litauen</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/LU.png" alt="" data-code="LU" data-value="11" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Luxemburg</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/NL.png" alt="" data-code="NL" data-value="4" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Niederlande</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/AT.png" alt="" data-code="AT" data-value="2" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Österreich</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/PL.png" alt="" data-code="PL" data-value="7" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Polen</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/SE.png" alt="" data-code="SE" data-value="13" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Schweden</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/CH.png" alt="" data-code="CH" data-value="10" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Schweiz</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/ES.png" alt="" data-code="ES" data-value="6" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Spanien</span></li><li style="list-style: none;width: 100%;border-radius: 5px;text-align: left;background-color: #fff;padding-top: 0.3rem;padding-bottom: 0.3rem;cursor: pointer;" onmouseover="this.style.backgroundColor='#0F74BC';this.style.color='#fff';" onmouseout="this.style.backgroundColor='#FFFFFF';this.style.color='#000000';"><img src="/img/flags/HU.png" alt="" data-code="HU" data-value="12" style="width: 20px;margin: 5px;"><span style="margin-left: 30px;cursor: pointer;">Ungarn</span></li></ul></div></div>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4">
									<input type="text" id="to_email" name="to_email" value="info@gzamotors.de" class="form-control" placeholder="Email">
								</div>
								<div class="col-sm-4">
									<input type="text" id="to_mobilnumber" name="to_mobilnumber" value="" class="form-control" placeholder="Mobil">
								</div>
								<div class="col-sm-4">
									<input type="text" id="to_phonenumber" name="to_phonenumber" value="042159564922" class="form-control" placeholder="Festnetz">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-4 col-form-label">Benachrichtigung</label>
								<div class="col-sm-7">
									<div class="custom-control custom-checkbox mt-2 pl-0">
										<input type="checkbox" id="to_mail" name="to_mail" value="1" class="custom-control-input bootstrap-switch" style="display: none;"><div class="btn-group btn-toggle" style="white-space: nowrap;"><button class="btn btn-default  btn-sm" style="float: none; display: inline-block; margin-right: 0px;">Ja</button><button class="btn active btn-danger btn-sm" style="float: none; display: inline-block; margin-left: 0px;">Nein </button></div>
										<label class="custom-control-label d-none" for="to_mail">
											Ja
										</label>
									</div>
								</div>
					...
					<div class="form-group row">
						<div class="col-sm-6 border-right">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" id="description" name="description" value="Steuergerät" class="form-control" placeholder="Hinweis">
								</div>
							</div>
							<div class="form-group row">
...
<option value="65" selected="selected">UPS Saver</option>
									</select>
								</div>
								<div class="col-sm-1">
								</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-2">
									<input type="number" id="length" name="length" step="1" value="30" class="form-control" placeholder="Länge" data-toggle="tooltip" data-placement="top" title="" data-original-title="Länge">
								</div>
								<div class="col-sm-2">
									<input type="number" id="width" name="width" step="1" value="20" class="form-control" placeholder="Breite" data-toggle="tooltip" data-placement="top" title="" data-original-title="Breite">
								</div>
								<div class="col-sm-2">
									<input type="number" id="height" name="height" step="1" value="10" class="form-control" placeholder="Höhe" data-toggle="tooltip" data-placement="top" title="" data-original-title="Höhe">
								</div>
								<div class="col-sm-2">
									<input type="number" id="weight" name="weight" step="0.1" value="5.0" class="form-control" placeholder="Gewicht" data-toggle="tooltip" data-placement="top" title="" data-original-title="Gewicht">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-2">
									<div class="custom-control custom-checkbox mt-2 pl-0">
										<input type="checkbox" id="radio_payment" name="radio_payment" value="1" class="custom-control-input bootstrap-switch" onchange="if($(this).prop('checked') == false){$('#amount_label').hide();$('#amount_amount').hide();}else{$('#amount_label').show();$('#amount_amount').show();}" style="display: none;"><div class="btn-group btn-toggle" style="white-space: nowrap;"><button class="btn btn-default  btn-sm" style="float: none; display: inline-block; margin-right: 0px; transform: scale(1);">Ja</button><button class="btn active btn-danger btn-sm" style="float: none; display: inline-block; margin-left: 0px; transform: scale(1);">Nein </button></div>
										<label class="custom-control-label d-none" for="radio_payment">
											Ja
										</label>
									</div>
								</div>
								<label id="amount_label" class="col-sm-2 col-form-label" style="display: none" for="amount">Betrag</label>
								<div id="amount_amount" class="col-sm-4" style="display: none">
									<div class="input-group">
										<input type="text" id="amount" name="amount" value="0,00" class="form-control">
							...
							<div class="form-group row">
								...
								<div class="col-sm-2">
									<div class="custom-control custom-checkbox mt-2 pl-0">
										<input type="checkbox" id="mail_with_pdf" name="mail_with_pdf" value="1" class="custom-control-input bootstrap-switch" style="display: none;"><div class="btn-group btn-toggle" style="white-space: nowrap;"><button class="btn btn-default  btn-sm" style="float: none; display: inline-block; margin-right: 0px;">Ja</button><button class="btn active btn-danger btn-sm" style="float: none; display: inline-block; margin-left: 0px;">Nein </button></div>
										<label class="custom-control-label d-none" for="mail_with_pdf">
											Ja
										</label>
									</div>
								</div>
							...
							<div class="form-group row">
								<label class="col-sm-4 col-form-label">Zusammenfassend versenden</label>
								<div class="col-sm-7">
									<div class="custom-control custom-checkbox mt-2 pl-0">
										<input type="checkbox" id="adding" name="adding" value="1" class="custom-control-input bootstrap-switch" style="display: none;"><div class="btn-group btn-toggle" style="white-space: nowrap;"><button class="btn btn-default  btn-sm" style="float: none; display: inline-block; margin-right: 0px;">Ja</button><button class="btn active btn-danger btn-sm" style="float: none; display: inline-block; margin-left: 0px;">Nein </button></div>
										<label class="custom-control-label d-none" for="adding">
											Ja
										</label>
									</div>
								</div>
					...
					<div class="row px-0 card-footer">
						<div class="col-sm-6">
							...
							<button type="submit" name="new_shipping" value="Sendung an Packtisch senden" class="btn btn-primary" style="transform: scale(1);">Sendung an Packtisch senden <i class="fa fa-floppy-o" aria-hidden="true"></i></button>
...
<script>
var dates = [
	{"id": 5226, "mode": 2, "today": false, "date": "01.11.2022 09:20"}, 
	{"id": 5216, "mode": 2, "today": false, "date": "01.11.2022 09:45"}, 
	{"id": 5214, "mode": 2, "today": false, "date": "01.11.2022 09:50"}, 
	{"id": 5067, "mode": 2, "today": false, "date": "01.11.2022 10:00"}, 
	{"id": 5201, "mode": 2, "today": false, "date": "01.11.2022 10:15"}, 
	{"id": 5192, "mode": 2, "today": false, "date": "01.11.2022 10:20"}, 
	{"id": 5162, "mode": 2, "today": false, "date": "01.11.2022 10:30"}, 
	{"id": 5129, "mode": 2, "today": false, "date": "01.11.2022 10:40"}, 
	{"id": 5200, "mode": 2, "today": false, "date": "01.11.2022 10:45"}, 
	{"id": 5219, "mode": 2, "today": false, "date": "01.11.2022 10:50"}, 
	{"id": 5194, "mode": 2, "today": false, "date": "01.11.2022 11:00"}, 
	{"id": 5178, "mode": 2, "today": false, "date": "01.11.2022 11:10"}, 
	{"id": 5231, "mode": 2, "today": false, "date": "01.11.2022 11:15"}, 
	{"id": 5188, "mode": 2, "today": false, "date": "01.11.2022 11:20"}, 
	{"id": 5196, "mode": 2, "today": false, "date": "01.11.2022 11:30"}, 
	{"id": 5210, "mode": 2, "today": false, "date": "01.11.2022 11:40"}, 
	{"id": 5213, "mode": 2, "today": false, "date": "01.11.2022 11:50"}, 
	{"id": 5161, "mode": 2, "today": false, "date": "01.11.2022 12:00"}, 
	{"id": 5168, "mode": 2, "today": false, "date": "01.11.2022 12:10"}, 
	{"id": 5217, "mode": 2, "today": false, "date": "02.11.2022 09:45"}, 
	{"id": 5222, "mode": 2, "today": false, "date": "02.11.2022 10:00"}, 
	{"id": 5204, "mode": 2, "today": false, "date": "02.11.2022 10:15"}, 
	{"id": 5205, "mode": 2, "today": false, "date": "02.11.2022 10:30"}, 
	{"id": 5215, "mode": 2, "today": false, "date": "02.11.2022 10:45"}, 
	{"id": 5229, "mode": 2, "today": false, "date": "02.11.2022 11:00"}, 
	{"id": 5227, "mode": 2, "today": false, "date": "02.11.2022 11:10"}, 
	{"id": 5209, "mode": 2, "today": false, "date": "02.11.2022 11:15"}, 
	{"id": 5223, "mode": 2, "today": false, "date": "02.11.2022 11:45"}, 
	{"id": 5228, "mode": 2, "today": false, "date": "02.11.2022 12:00"}, 
	{"id": 5225, "mode": 2, "today": false, "date": "03.11.2022 10:15"}, 
	{"id": 5080, "mode": 2, "today": false, "date": "03.11.2022 10:30"}, 
	{"id": 5187, "mode": 2, "today": false, "date": "03.11.2022 10:45"}, 
	{"id": 5224, "mode": 2, "today": false, "date": "03.11.2022 11:20"}, 
	{"id": 5221, "mode": 2, "today": false, "date": "03.11.2022 11:35"}, 
	{"id": 5207, "mode": 2, "today": false, "date": "03.11.2022 11:45"}, 
	{"id": 5220, "mode": 2, "today": false, "date": "04.11.2022 10:00"}, 
	{"id": 5126, "mode": 2, "today": false, "date": "07.11.2022 11:00"}, 
	{"id": 5156, "mode": 2, "today": false, "date": "07.11.2022 11:45"}, 
	{"id": 5026, "mode": 2, "today": false, "date": "08.11.2022 10:45"}, 
	{"id": 5218, "mode": 2, "today": false, "date": "09.11.2022 10:00"}, 
...
var countryToId = {'Deutschland': 1, 'Großbritannien': 5, 'Italien': 8, 'Litauen': 9, 'Luxemburg': 11, 'Niederlande': 4, 'Österreich': 2, 'Polen': 7, 'Schweden': 13, 'Schweiz': 10, 'Spanien': 6, 'Ungarn': 12};
