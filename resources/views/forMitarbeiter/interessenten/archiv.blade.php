<html lang="de"><head><title>CRM P+</title>
    <title>ORDERGO-CRM - Interessentenarchiv</title>
    ...
    <div class="row">
        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                    <a href="/crm/interessenten-archiv" class="nav-link active">Archiv</a>
                </li>
                <li class="nav-item">
    ...
    <div>
            <form action="/crm/interessenten-archiv" method="post">
    ...
    <div class="col-sm-1"></div><div class="col-sm-1 text-right"><select name="admin_id" class="custom-select custom-select-sm d-none">	<option value="1">Gazi Ahmad</option>
        ...
        <option value="8" selected="selected">Dummy Mitarbeiter</option>
    ...
    <div class="card_lb_success bg-white text-left shadow">
        <div class="card_lb_content">
            ...
            <span class="card_lb_value">0 von 223</span>
        </div>
    ...
    <div class="card_lb_warning bg-white text-left shadow">
        <div class="card_lb_content">
            <span class="card_lb_title text-warning">Offene Interessenten</span><span class="card_lb_percent">27%</span><br>
            <span class="card_lb_value">62 von 223</span>
        </div>
        <div class="card_lb_logo text-center mt-1">
    ...
    <div class="row">
        <div class="col-7">
            <h3>Interessentenarchiv</h3>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right">
                    <form id="order_search" action="/crm/interessenten-archiv" method="post">
                <div class="form-group row mb-1">
                    <div class="col-sm-12">
    ...
    <form action="/crm/interessenten-archiv" method="post"></form>
        <tbody>
        @foreach ($person as $p)
        <tr class="interesteds_archiv_menu" onclick="if($(this).hasClass('active')){$(this).removeClass('active');}else{$(this).addClass('active');}$('#order_list_5282').prop('checked', !$('#order_list_5282').prop('checked'))" data-id="5282" data-order_number="80423">
            <td scope="row">
                <div class="custom-control custom-checkbox mt-1 ml-2">
                    <input type="checkbox" id="order_list_5282" data-id="5282" class="custom-control-input order-list" onclick="if($(this).closest('tr').hasClass('active')){$(this).closest('tr').removeClass('active');}else{$(this).closest('tr').addClass('active');}">
                    <label class="custom-control-label" for="order_list_5282"></label>
                </div>
            </td>
            ...
            <td class="text-nowrap">
                <small>{{$p->created_at->format("d.m.Y")}}</small> <small class="text-muted">({{$p->updated_at->format("h:m")}})</small>
            </td>
            <td scope="row">
    ...
    <form action="/crm/interessenten-archiv" method="post">
        <table class="table table-white table-sm mb-0">
            <tbody><tr class="text-primary">
                ...
                <td width="350">
                    <label for="order_sel_all_bottom" class="mt-1">alle auswählen (1 bis 271 von 271 Einträgen)</label>
                </td>
                <td width="260">
    ...
    var dates = [
        ...
        {"id": 5265, "mode": 2, "today": true, "date": "11.11.2022 11:00"}, 
        {"id": 5278, "mode": 2, "today": true, "date": "11.11.2022 11:05"}, 
        ...
        {"id": 5284, "mode": 2, "today": false, "date": "14.11.2022 09:45"}, 
        ...
        {"id": 5232, "mode": 2, "today": false, "date": "14.11.2022 11:30"}, 
        {"id": 5115, "mode": 2, "today": false, "date": "14.11.2022 11:45"}, 
        {"id": 5311, "mode": 2, "today": false, "date": "15.11.2022 09:30"}, 
        {"id": 5312, "mode": 2, "today": false, "date": "15.11.2022 10:00"}, 
        ...
        {"id": 5302, "mode": 2, "today": false, "date": "17.11.2022 09:30"}, 
    ...
    $(function(){
        ...
        $('#order_sel_all_top, #order_sel_all_bottom, .interesteds_archiv_menu').on('click', function(){
            var countCkecked = 0;
