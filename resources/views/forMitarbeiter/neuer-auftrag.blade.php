...
<div class="row">
	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
		<ul class="nav nav-pills">
			...
			<li class="nav-item">
				<a href="/crm/neue-auftraege/neuer-auftrag" class="nav-link active">Neuer Auftrag</a>
			</li>
			<li class="nav-item">
			...
			<div class="card-body px-3 pt-3 pb-0">
				<form action="/employee/neuen-auftrag/anlegen" method="post" enctype="multipart/form-data" onsubmit="var sumsize=0;for(var i=0;i<document.getElementById('file_document_add').files.length;i++){sumsize+=document.getElementById('file_document_add').files[i].size;}if(sumsize>(32*1024*1024)){alert('Die upload Datengröße ist zu hoch. Es sind nur 32MB insgesammt erlaubt!');return false;}else{return true;}">
					...
					<div class="row">
						<div class="col-6 border-right">
							<div class="form-group row">
								...
								<div class="col-sm-3">
									<input type="text" id="date" name="date_1" value="{{date('d.m.Y')}}" class="form-control" disabled="disabled" />
								</div>
								<div class="col-sm-1">
								</div>
								<label for="admin_id" class="col-sm-2 col-form-label">Mitarbeiter</label>
								<div class="col-sm-3">
									<select id="admin_id_1" name="employee_name" class="custom-select d-none">
								...
								<option value="31" selected="selected">Masterpacktisch</option>
									...
									<input type="text" id="admin_id" name="employee" value="Masterpacktisch" disabled="disabled" class="form-control" />
								</div>
								<div class="col-sm-1">
								</div>
							</div>
							...
							<div class="form-group row">
								<div class="col-sm-12">
									<input type="text" id="companyname" name="company_name" value="" class="form-control" placeholder="Firma" />
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="gender_0" name="gender" value="herr" checked="checked" class="custom-control-input" />
										<label class="custom-control-label" for="gender_0">
											Herr
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="gender_1" name="gender" value="frau" class="custom-control-input" />
								...
								<div class="col-sm-4">
									<input type="text" id="firstname" name="firstname" value="" class="form-control" placeholder="Vorname" />
								</div>
								<div class="col-sm-4">
									<input type="text" id="lastname" name="lastname" value="" class="form-control" placeholder="Nachname" />
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-9">
									<input type="text" id="routde" name="home_street" value="" class="form-control" placeholder="Straße"  />
								</div>
								<div class="col-sm-3">
									<input type="text" id="street_number" name="home_street_number" value="" class="form-control" placeholder="Nr" />
								</div>
							</div>
							<div class="form-group row">
								<div class="col-sm-4">
									<input type="text" id="postal_code" name="home_zipcode" value="" class="form-control" placeholder="Postleitzahl"  />
								</div>
								<div class="col-sm-4">
									<input type="text" id="locality" name="home_city" value="" class="form-control" placeholder="Ort"/>
								</div>
								<div class="col-sm-4">
									<select id="country" name="home_country" class="custom-select">
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<input type="text" id="mobilnumber" name="mobil_number" value="" class="form-control" placeholder="Mobil" />
								</div>
								<div class="col-sm-4">
									<input type="text" id="phonenumber" name="phone_number" value="" class="form-control" placeholder="Festnetz" />
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-4 col-form-label">Zur abweichenden Sendungsadresse</label>
								<div class="col-sm-8">
							...
							<div id="differing_shipping_address_hide" class="d-block">
								<div class="form-group row">
									<div class="col-sm-12">
										<input type="text" id="differing_companyname" name="send_back_company_name" value="" class="form-control" placeholder="Firma" />
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-4 mt-2">
										<div class="custom-control custom-radio d-inline mr-3">
											<input type="radio" id="differing_gender_0" name="send_back_gender" value="her" checked="checked" class="custom-control-input" />
											<label class="custom-control-label" for="differing_gender_0">
												Herr
											</label>
										</div>
										<div class="custom-control custom-radio d-inline mr-3">
											<input type="radio" id="differing_gender_1" name="send_back_gender" value="frau" class="custom-control-input" />
									...
									<div class="col-sm-4">
										<input type="text" id="differing_firstname" name="send_back_firstname" value="" class="form-control" placeholder="Vorname" />
									</div>
									<div class="col-sm-4">
										<input type="text" id="differing_lastname" name="send_back_lastname" value="" class="form-control" placeholder="Nachname" />
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-9">
										<input type="text" id="differing_route" name="send_back_street" value="" class="form-control" placeholder="Straße" onFocus="geolocate('differing_route')" />
									</div>
									<div class="col-sm-3">
										<input type="text" id="differing_street_number" name="send_back_street_number" value="" class="form-control" placeholder="Nr" />
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-4">
										<input type="text" id="differing_postal_code" name="send_back_zipcode" value="" class="form-control" placeholder="Postleitzahl" onFocus="geolocate('differing_postal_code')" />
									</div>
									<div class="col-sm-4">
										<input type="text" id="differing_locality" name="send_back_city" value="" class="form-control" placeholder="Ort" onFocus="geolocate('differing_locality')" />
									</div>
									<div class="col-sm-4">
										<select id="differing_country" name="send_back_country" class="custom-select">
								<option value="1" data-code="DE" selected="selected">Deutschland</option>
								<option value="5" data-code="GB">Großbritannien</option>
								<option value="8" data-code="IT">Italien</option>
								<option value="9" data-code="LT">Litauen</option>
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<div class="input-group">
										<input type="text" id="pricemwst" name="pricemwst" value="0,00" class="form-control" />
							...
							<div class="form-group row">
								...
								<div class="col-sm-8 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="radio_shipping_standart" name="shipping_type" value="standard" checked="checked" class="custom-control-input" />
										<label class="custom-control-label" for="radio_shipping_standart">
											Standard
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="radio_shipping_express" name="shipping_type" value="express" class="custom-control-input" />
										<label class="custom-control-label" for="radio_shipping_express">
											Express
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="radio_shipping_international" name="shipping_type" value="international" class="custom-control-input" />
										<label class="custom-control-label" for="radio_shipping_international">
											International
										</label>
									</div>
									<div class="custom-control custom-radio d-inline">
										<input type="radio" id="radio_shipping_self" name="shipping_type" value="pickup" class="custom-control-input" />
										<label class="custom-control-label" for="radio_shipping_self">
											Abholung
										</label>
									</div>
									<div class="custom-control custom-radio d-inline">
										<input type="radio" id="radio_shipping_samstagszustellung" name="shipping_type" value="samstagszustellung" class="custom-control-input" />
										<label class="custom-control-label" for="radio_shipping_samstagszustellung">
											Samstagszustellung
										</label>
									</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="radio_payment_nachnahme" name="payment_type" value="nachnahme" class="custom-control-input" />
										<label class="custom-control-label" for="radio_payment_nachnahme">
											Nachnahme
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="radio_payment_ueberweisung" name="payment_type" value="transaction" checked="checked" class="custom-control-input" />
										<label class="custom-control-label" for="radio_payment_ueberweisung">
											Überweisung
										</label>
									</div>
									<div class="custom-control custom-radio d-inline">
										<input type="radio" id="radio_payment_bar" name="payment_type" value="cash" class="custom-control-input" />
						...
						<div class="col-6">
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<input type="text" id="machine" name="car_company" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								<label for="model" class="col-sm-4 col-form-label">Automodell</label>
								<div class="col-sm-5">
									<input type="text" id="model" name="car_model" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								<label for="constructionyear" class="col-sm-4 col-form-label">Baujahr</label>
								<div class="col-sm-5">
									<input type="text" id="constructionyear" name="production_year" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								<label for="carid" class="col-sm-4 col-form-label">FIN / VIN</label>
								<div class="col-sm-5">
									<input type="text" id="carid" name="car_identification_number" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								<label for="kw" class="col-sm-4 col-form-label">Fahrleistung (PS)</label>
								<div class="col-sm-5">
									<input type="text" id="kw" name="car_power" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<div class="input-group date">
										<input type="text" id="mileage" name="mileage" value="0" class="form-control" />
							...
							<div class="form-group row">
								...
								<div class="col-sm-5 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="mechanism_0" name="transmission" value="circuit" checked="checked" class="custom-control-input" />
										<label class="custom-control-label" for="mechanism_0">
											Schaltung
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="mechanism_1" name="transmission" value="automatic" class="custom-control-input" />
							...
							<div class="form-group row">
								...
								<div class="col-sm-5 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="fuel_0" name="fuel_type" value="petrol" checked="checked" class="custom-control-input" />
										<label class="custom-control-label" for="fuel_0">
											Benzin
										</label>
									</div>
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="fuel_1" name="fuel" value="diesel" class="custom-control-input" />
							...
							<div id="with_device" style="display: block">
							<div class="form-group row">
								<div class="col-sm-12">
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<select id="component" name="broken_component" class="custom-select">
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<input type="text" id="manufacturer" name="component_company" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								<label for="serial" class="col-sm-4 col-form-label">Teile.-/Herstellernummer</label>
								<div class="col-sm-5">
									<input type="text" id="serial" name="component_number" value="" class="form-control" />
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-5 mt-2">
									<div class="custom-control custom-radio d-inline mr-3">
										<input type="radio" id="fromthiscar_yes" name="from_car" value="yes" checked="checked" class="custom-control-input" />
										<label class="custom-control-label" for="fromthiscar_yes">
											Ja
										</label>
									</div>
									<div class="custom-control custom-radio d-inline">
										<input type="radio" id="fromthiscar_no" name="from_car" value="no" class="custom-control-input" />
							...
							<div class="form-group row">
								...
								<div class="col-sm-8 text-right">
									<textarea id="reason" name="error_message" style="height: 160px" class="form-control" onkeyup="if(this.value.length >= 700){this.value = this.value.substr(0, 700);alert('Die maximale Anzahl an erlaubten Zeichen wurde erreicht!');}$('#reason_length').html(this.value.length);"></textarea>
									<small>(<span id="reason_length">0</span> von 700 Zeichen)</small>
								</div>
							</div>
							<div class="form-group row">
								<label for="description" class="col-sm-4 col-form-label">Fehlerspeicher</label>
								<div class="col-sm-8 text-right">
									<textarea id="description" name="error_message_cache" style="height: 160px" class="form-control" onkeyup="if(this.value.length >= 700){this.value = this.value.substr(0, 700);alert('Die maximale Anzahl an erlaubten Zeichen wurde erreicht!');}$('#description_length').html(this.value.length);"></textarea>
									<small>(<span id="description_length">0</span> von 700 Zeichen)</small>
								</div>
							</div>
							<div class="form-group row">
					...
					<div class="row px-0 card-footer">
						<div class="col-sm-6">
							<input type="hidden" name="run_date" value="1665652054" />
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12 col-xs-12 text-right">
				<p class="copyright text-dark m-0">Copyright &copy; 2022 <span><a href="/index" class="text-primary">Verwaltungssystem</a></span> All Right Of Reserved</p>
			</div>
		</div>
	</div>
...
var dates = [
	...
	{"id": 5166, "mode": 2, "today": true, "date": "25.10.2022 12:10"}, 
	{"id": 5094, "mode": 2, "today": true, "date": "25.10.2022 12:15"}, 
	{"id": 5125, "mode": 2, "today": true, "date": "25.10.2022 12:20"}, 
	{"id": 5110, "mode": 2, "today": true, "date": "25.10.2022 12:30"}, 
	{"id": 5140, "mode": 2, "today": true, "date": "25.10.2022 12:35"}, 
	...
	{"id": 5174, "mode": 2, "today": false, "date": "26.10.2022 11:40"}, 
	{"id": 5158, "mode": 2, "today": false, "date": "26.10.2022 11:45"}, 
	{"id": 5152, "mode": 2, "today": false, "date": "26.10.2022 11:50"}, 
	...
	{"id": 5129, "mode": 2, "today": false, "date": "27.10.2022 10:40"}, 
	...
	{"id": 5062, "mode": 2, "today": false, "date": "27.10.2022 11:45"}, 
	{"id": 5192, "mode": 2, "today": false, "date": "28.10.2022 10:00"}, 
	{"id": 5191, "mode": 2, "today": false, "date": "28.10.2022 10:15"}, 
