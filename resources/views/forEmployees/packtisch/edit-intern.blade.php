        ...
        <div class=" ">
            ...
            <div class="col-span-2">
                <button class="grid ml-4 mt-8 w-36 float-left" type="button" >
                    <div id="device-div-versand-kunde-gummi" onclick="toggleZusatzartikel('gummi')" class=" w-full px-2 py-1 rounded-md border border-gray-300 text-gray-500 hover:border-blue-400 hover:text-blue-400">
                ...
                <button type="button" class="mt-8 grid float-left w-36 ml-4">
                    <div id="device-div-versand-kunde-prot" onclick="toggleZusatzartikel('prot')" class=" w-full  px-1 py-1 rounded-md border border-gray-300 text-gray-500 hover:border-blue-400 hover:text-blue-400">
                ...
                <button type="button" class=" col-start-2 w-36 grid float-left ml-4 mt-8">
                    <div id="device-div-versand-kunde-seal" onclick="toggleZusatzartikel('seal')" class=" w-full px-2 py-1 rounded-md border border-gray-300 text-gray-500 hover:border-blue-400 hover:text-blue-400">
...
function uploadKundenversandDocuments() {
        ...
        Array.from(document.getElementById("versand-kunde-fileinput").files)
          .forEach(parentFile => {
            ...
            button.innerHTML = '<p class="overflow-hidden text-center">'+ parentFile["name"] + '</p>';
