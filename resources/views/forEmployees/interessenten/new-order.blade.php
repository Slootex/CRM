...
<body>
  ...
  @include('layouts.top-menu', ["menu" => "interessent", "undermenu" => "neu"])

  <form class="space-y-6" action="{{url("/")}}/employee/neuen-interessenten/anlegen" method="POST" enctype="multipart/form-data">

  <h1 class="text-black text-5xl font-bold py-3 pl-10">Neuer Interessent (Intern)</h1>
    <div class=" m-auto" style="width: 75rem;">
            
            @CSRF
            <div class="bg-white border border-gray-300 px-4 -md -white sm:rounded-md h-auto" id="rechnungsadresse" style="height: 48rem;">
              ...
              <script>
                function loadKundenDaten(id) {
                  $.post( "{{url("/")}}/crm/neuer-interessent/auftragsuche", {
          kunden_id: id,
              ...
              <div class="pl-12 pt-2 pl-16 float-left" style="width: 60rem;">
                ...
                <div>
                  ...
                  <div class="relative w-96 h-16 float-left mt-8">
                    <button type="button" onclick="document.getElementById('alt_adr').classList.toggle('hidden')" class="bg-blue-600 hover:bg-blue-500 px-4 font-semibold text-lg py-2 text-white rounded-md ">
      ...
      $('#long').val(place.geometry['location'].lng());
                  ...
                  <div class="bg-white border border-gray-300 px-4 -md -white sm:rounded-md h-auto hidden" id="alt_adr" style="height: 25rem;">
                    ...
                    <div class="pl-12 pt-2 pl-16 float-left" style="width: 60rem;">
                      ...
                      <div class="float-left pt-4">
                        <div class="float-left pt-6">
                          <div class="relative">
                            <label for="name" class="absolute -top-2 left-2 inline-block bg-white px-1 text-sm font-medium text-gray-900">Straße</label>
                            <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" type="text" style="width: 37rem;" name="send_back_street" id="send_back_street" class="block  h-11 rounded-md border-0 py-1.5 text-gray-900 -sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-md sm:leading-6">
                          </div>
                        </div>
                        <div class="float-left pl-4 pt-6">
                          <div class="relative">
            ...
            <div class="bg-white px-4 border border-gray-300 -md -white sm:rounded-md m-auto mt-8" id="fahrzeugdaten" style="height: 30.5rem; width: 75rem;">
...
<div class="absolute pt-3 overflow-auto break-words " style="max-width: 14rem;">
  ...
  <div class="px-3 py-3 border-2 border-blue-700 rounded-lg mt-2 hidden ml-3" id="box">
    ...
    <p class="text-gray-500"><span id="box-fuel">Benzin</span> / <span id="box-getr">Schaltung</span></p>
              ...
              <div class="ml-60 pl-.5 pt-7">
                ...
                <div class="w-full h-16 pr-16">
                  ...
                  <fieldset class="ml-0 float-left w-96 pt-6">
                    <div class="space-y-4">
                      <div class="pr-4">
                        <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" id="benzin" name="fuel_type" oninput="document.getElementById('box-fuel').innerHTML = 'Benzin'" value="Benzin" type="radio" checked class="float-left mt-1 h-5 w-5 border-gray-300 text-blue-600 focus:ring-blue-600">
                        <label for="email" class="ml-3 block text-md font-medium leading-6 text-gray-900 float-left pr-8">Benzin</label>
                      </div>
                
                      <div>
                        <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" id="diesel" name="fuel_type"  oninput="document.getElementById('box-fuel').innerHTML = 'Diesel'" value="Diesel" type="radio" class="h-5 mt-1 w-5 border-gray-300 text-blue-600 focus:ring-blue-600 float-left">
            ...
            <div class="bg-white border border-gray-300 px-4 -md -white sm:rounded-md m-auto mt-8" style="height: 16rem; width: 75rem;" id="gerätedaten">
              
              <div class="absolute pt-2">
                <h2 class="text-black pt-3 pl-3 text-xl font-semibold">Gerätedaten</h2>
              </div>
                  ...
                  <fieldset class="ml-0 float-left w-96 pt-6">
                    <div class="space-y-4 float-right w-60">
                      <div class="pr-2 mt-4 float-right">
                        <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" id="email" name="opend" value="yes" type="radio" checked class="float-left mt-1 h-5 w-5 border-gray-300 text-blue-600 focus:ring-blue-600">
                        <label for="email" class="ml-3 block text-md font-medium leading-6 text-gray-900 float-left pr-8">Nein</label>
                      </div>
                
                      <div class="float-right">
                        <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" id="sms" name="opend" value="no" type="radio" class="h-5 mt-1 w-5 border-gray-300 text-blue-600 focus:ring-blue-600 float-left">
                  ...
                  <fieldset class="ml-0 float-left w-96 pt-6">
                    <div class="space-y-4 float-left w-60 pl-1 ml-20">
                      <div class="pr-4 float-left mt-4 ">
                        <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" id="email" value="yes" name="from_car" type="radio" checked class="float-left mt-1 h-5 w-5 border-gray-300 text-blue-600 focus:ring-blue-600">
                      ...
                      <div class="pr-4 float-left">
                        <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" id="sms" value="no" name="from_car" type="radio" class="h-5 mt-1 w-5 border-gray-300 text-blue-600 focus:ring-blue-600 float-left">
            ...
            <div class="bg-white border border-gray-300 px-4 -md -white sm:rounded-md m-auto mt-8 h-auto py-4" style=" width: 75rem;" id="fehlerbeschreibung">
              ...
              <div class="ml-60 pl-.5 pt-0">
                ...
                <div class="grid grid-cols-6 gap-2 mt-6">
                  ...
                  <div class="relative ml-32 pl-3 mt-8">
                    ...
                    <input onkeypress="if(event.keyCode == 13) { event.preventDefault(); }" type="text" name="name" id="home_city" class="block ml-4 w-96 h-11 rounded-md border-0 py-1.5   text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-md sm:leading-6">
                  </div>
                </div>
              </div>

              <div class="float-right w-96 mt-4 py-6">
                ...
                <button type="button" onclick="checkBeforeSubmit()" class="bg-blue-600 hover:bg-blue-500 text-white rounded-md px-6 py-1 rounded-tr-none rounded-br-none float-right">
                  <p class="font-semibold">Auftrag erstellen</p>
    ...
    <script>
      ...
      function searchNumber() {
        ...
        tsn_v = document.getElementById("tsn").value;
        ...
        $.post( "{{url("/")}}/crm/neuer-auftrag/nummersuche", {
          ...
          if(data != "empty") {
            ...
            document.getElementById("car-model").value = data["MF"].split(" ")[1];
            document.getElementById("box-model").innerHTML = document.getElementById("car-model").value;
            document.getElementById("ps").value = data["leistung"];
...
<div class="relative z-10 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="number-error">
  <div class="fixed inset-0 bg-white0 bg-opacity-75 transition-opacity"></div>
