...
<body>
  ...
  @include('layouts.top-menu', ["menu" => "auftrag", "undermenu" => "neu"])




  <h1 class="text-black text-5xl font-bold py-3 pl-10">Neuer Auftrag (Intern)</h1>
    <div class=" m-auto" style="width: 75rem;">
        <form class="space-y-6" action="{{url("/")}}/employee/neuen-auftrag/anlegen" method="POST" enctype="multipart/form-data">
