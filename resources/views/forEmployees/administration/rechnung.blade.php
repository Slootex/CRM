...
<body onload="createBarcode()">
    ...
    <div id="main" class="">
        ...
        <div >
            <p style="text-align: right; font-family: Arial; font-size: 11px;">GZA MOTORS</p>
            <p style="text-align: right; font-family: Arial; font-size: 11px; margin-top: -12px">Strausberger Platz 13</p>       

            <p style="text-align: right; font-family: Arial; font-size: 11px; margin-top: -11px">10243 Berlin</p>       

            <p style="text-align: right; font-family: Arial; font-size: 11px; margin-top: -4px;">Deutschland</p>       

            <p style="text-align: right; font-family: Arial; font-size: 11px; margin-top: -4px;">Telefon: 042159564922</p>       

            <p style="text-align: right; font-family: Arial; font-size: 11px; padding-bottom: 10px; margin-top: -12px">Telefax: 042117668953</p>       


            <p style="text-align: right; font-family: Arial; font-size: 11px; margin-top: -12px">info@gzamotors.de</p>       

            <p style="text-align: right; font-family: Arial; font-size: 11px; margin-top: -12px">www.gzamotors.de</p>

        </div>
        <div style="width: 40px; height: .1vw; border: solid black .1vw; border-top: none; border-left: none; border-right: none; position: absolute; margin-top: 48px;"></div>
        <div style="width: 40px; height: .1vw; border: solid black .1vw; border-top: none; border-left: none; border-right: none; position: absolute; margin-top: 48px; margin-left: 280px;"></div>

        <div style="width: 40px; height: .1vw; border: solid black .1vw; border-top: none; border-left: none; border-right: none; position: absolute; margin-top: 228px;"></div>
        <div style="width: 40px; height: .1vw; border: solid black .1vw; border-top: none; border-left: none; border-right: none; position: absolute; margin-top: 228px; margin-left: 280px;"></div>

        <div style="width: .1vw; height: 40px; border-top: none; border-left: solid black .1vw; border-right: none; position: absolute; margin-top: 190px;"></div>
        <div style="width: .1vw; height: 40px; border-top: none; border-left: solid black .1vw; border-right: none; position: absolute; margin-top: 190px; margin-left: 320px;"></div>

        <div style="width: .1vw; height: 40px; border-top: none; border-left: solid black .1vw; border-right: none; position: absolute; margin-top: 49px;"></div>
        <div style="width: .1vw; height: 40px; border-top: none; border-left: solid black .1vw; border-right: none; position: absolute; margin-top: 49px; margin-left: 320px;"></div>

        <div style="margin-top: 50px; margin-left: 0px;  width: 290px; padding: 15px; position: absolute">
        ...
        <div style="width: 360px; height: 280px; border: solid black .1vw; margin-left: 340px; margin-top: 100px;">
        ...
        <div style="position: absolute; width: 100%; margin-top: 55px; margin-left: -10px;">
            <table style="width: 100vw">
                <th style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; border: solid black .1vw; width: 100vw; position: absolute; height: 34px; border-left: none; border-right: none; border-top: none;">
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>Pos</b></td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>Menge</b></td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>Art.Nr</b></td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>Bezeichnung</b></td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>Gesamt</b><br>
                        <b>(Netto)</b></td>
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>MwSt</b></td>
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>E-Preis</b></td>
                        <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; "><b>Gesamt</b><br>
                            <b>(Brutto)</b></td>
                ...
                <tr>
                    <td ></td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">1</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">1</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">86301</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">Auftrag Steuergerät MSG - 580 , ABS - 450</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">1030,00</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">19%</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">1030,00</td>
                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px;">1225,70</td>
                </tr>
            </table>

            <p style="position: absolute; margin-left: 400px; font-family: Arial, Helvetica, sans-serif; font-size: 16px;"><b>Gesamtpreis Netto</b></p>
            <p style="position: absolute; font-family: Arial, Helvetica, sans-serif; font-size: 16px; margin-left: 650px;"><b>1.035,95</b></p>

            <p style="position: absolute; margin-left: 400px; font-family: Arial, Helvetica, sans-serif; font-size: 16px; margin-top: 45px;">MwSt. 19,00%</p>
            <p style="position: absolute; font-family: Arial, Helvetica, sans-serif; font-size: 16px; margin-left: 650px; margin-top: 45px;">1.035,95</p>

            <p style="position: absolute; margin-left: 400px; font-family: Arial, Helvetica, sans-serif; font-size: 16px; margin-top: 70px;"><b>Gesamtpreis Brutto</b></p>
            <p style="position: absolute; font-family: Arial, Helvetica, sans-serif; font-size: 16px; margin-left: 650px; margin-top: 70px;"><b>1.035,95</b></p>

            
        </div>
        <div style="position: absolute; width: 99%; margin-top: 250px; margin-left: -9px; border: solid black .1vw; height: 80px;">
    ...
    <script>
        function createBarcode() {
            ...
            document.getElementById("barcode").style.marginTop = "423px";
            document.getElementById("barcode").style.marginLeft = "500px";
        }
    </script>
</body>
</html>