<div class="absolute inline-block text-left ml-10 h-96 hidden z-50" id="orders-filter-dropdown">
      ...
      <div class="py-1" role="none">
        ...
        <div class="px-6 py-2">
            ...
            <div class="float-right ml-1">
                ...
                <select id="status-dropdown" name="location" class=" block w-36 rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    ...
                    @endif
                    @foreach ($statuses->sortBy("name") as $stat)
        ...
        <div class="px-6 py-2 mt-14">
            ...
            <div class="float-right ml-1">
                ...
                <select id="buchhaltung-dropdown" name="buchhaltung" class=" block w-36 rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                  ...
                  <option value="" class="font-semibold">Rechnungen</option>
  ...
  <form action="{{url("/")}}/crm/filter/globale-suche" method="POST">
    @CSRF
    ...
    <input type="hidden" name="global_keyword" id="keyword-filter" value="{{$search_option}}">
